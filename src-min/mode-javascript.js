define("ace/mode/jsdoc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(e, t, n) {
    "use strict";
    var r = e("../lib/oop"),
...
}), define("ace/mode/javascript_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/jsdoc_comment_highlight_rules", "ace/mode/text_highlight_rules"], function(e, t, n) {
    "use strict";
        ...
        u = function(e) {
            var t = {
                ...
                l = {
                    ...
                    regex: "(\\b(?!" + Object.values(t).join("|") + "\\b)" + o + ")(\\s*)(\\()"
                };
            this.$rules = {
                no_regex: [i.getStartRule("doc-start"), f("no_regex"), l, {
                    token: "string",
                    regex: "'(?=.)",
                    next: "qstring"
                }, {
            ...
            this.add("string_dquotes", "insertion", function(e, t, n, r, i) {
                if (i == '"' || i == "'") {
                    ...
                    var f = n.getCursorPosition(),
                        ...
                        p = h.getCurrentToken();
                    if (c == u && (o(p, "attribute-value") || o(p, "string"))) return {
                        text: "",
                        selection: [1, 1]
                    };
                    p || (p = h.stepBackward());
...
}), define("ace/mode/behaviour/javascript", ["require", "exports", "module", "ace/lib/oop", "ace/token_iterator", "ace/mode/behaviour/cstyle", "ace/mode/behaviour/xml"], function(e, t, n) {
    "use strict";
    var r = e("../../lib/oop"),
    ...
    (function() {
        this.getFoldWidget = function(e, t, n) {
            ...
            if (s) return new i(s.openTag.end.row, s.openTag.end.column, s.closeTag.start.row, s.closeTag.start.column)
        }
    }).call(o.prototype)
...
}), define("ace/mode/folding/javascript", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/xml", "ace/mode/folding/cstyle"], function(e, t, n) {
    "use strict";
    var r = e("../../lib/oop"),
        i = e("./xml").FoldMode,
        s = e("./cstyle").FoldMode,
...
}), define("ace/mode/javascript", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/javascript_highlight_rules", "ace/mode/matching_brace_outdent", "ace/worker/worker_client", "ace/mode/behaviour/javascript", "ace/mode/folding/javascript"], function(e, t, n) {
    "use strict";
    var r = e("../lib/oop"),
        i = e("./text").Mode,
